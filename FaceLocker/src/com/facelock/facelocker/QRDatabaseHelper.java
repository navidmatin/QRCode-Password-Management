...
public class QRDatabaseHelper {
   ...
   public QRDatabaseHelper(Context context) {
      ...
      FaceLockerOpenHelper openHelper = new FaceLockerOpenHelper(this.context);
   ...
   private static class FaceLockerOpenHelper extends SQLiteOpenHelper {
	   FaceLockerOpenHelper(Context context) {
